...
class ClientRegistrationPageInfoState extends ChangeNotifier {
...
class ClientRegistrationPageInfo extends StatefulWidget {
  final int userId;

  ClientRegistrationPageInfo({required this.userId});

  @override
  _ClientRegistrationPageInfoState createState() => _ClientRegistrationPageInfoState();
}

class _ClientRegistrationPageInfoState extends State<ClientRegistrationPageInfo> {
  ClientRegistrationPageInfoState _clientRegistrationPageInfoState = ClientRegistrationPageInfoState();
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (pickedDate != null) {
      setState(() {
        _clientRegistrationPageInfoState.birthDateController.text = DateFormat('yyyy-MM-dd').format(pickedDate);
      });
    }
  }
  ...
  Future<void> _submitRequest() async {
    final newRequest = ClientRegistrationInfoRequest(
      ...
      surname: _clientRegistrationPageInfoState.surnameController.text,
      name: _clientRegistrationPageInfoState.nameController.text,
      birthDate: _clientRegistrationPageInfoState.birthDateController.text,
      phoneNumber: _clientRegistrationPageInfoState.phoneNumberController.text,
      identityNumberKZT: _clientRegistrationPageInfoState.identityNumberController.text,
    );
    ...
    final newAddressRequest = ClientRegistrationAdressRequest(
      ...
      houseNumber: _clientRegistrationPageInfoState.numberOfHouseController.text,
      apartmentNumber: _clientRegistrationPageInfoState.numberOfApartmentController.text,
    );
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildTextField(
                  ...
                  icon: Icons.person,
                  label: 'Фамилия',
                  controller: _clientRegistrationPageInfoState.surnameController,
                ),
                SizedBox(height: 16.0),
                _buildTextField(
                  context,
                  ...
                  label: 'Имя',
                  controller: _clientRegistrationPageInfoState.nameController,
                ),
                SizedBox(height: 16.0),
                TextField(
                  controller: _clientRegistrationPageInfoState.birthDateController,
                ...
                _buildTextField(
                  ...
                  controller: _clientRegistrationPageInfoState.phoneNumberController,
                ),
                SizedBox(height: 16.0),
                _buildTextField(
                  context,
                  ...
                  label: 'ИИН',
                  controller: _clientRegistrationPageInfoState.identityNumberController,
                ),
                SizedBox(height: 16.0),
                _buildTextField(
                  context,
                  ...
                  label: 'Номер дома',
                  controller: _clientRegistrationPageInfoState.numberOfHouseController,
                ),
                SizedBox(height: 16.0),
                _buildTextField(
                  context,
                  ...
                  controller: _clientRegistrationPageInfoState.numberOfApartmentController,
                ),
                SizedBox(height: 16.0),
